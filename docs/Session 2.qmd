...
**Step 1: Book chapter reading.** Read [chapter 3](https://r4ds.hadley.nz/data-transform.html){target="_blank"} in the *R for Data Science*. We are skipping chapter 2 because we already talked about most of its content last Thursday. Leave the exercises for later.    
...
**Step 3.5: One-on-one meetings.** As we did last week, we’ll hold individual check-ins on Tuesday, with each meeting scheduled for about 30 minutes. If you need more time or extra help, you are welcome to request a longer session.

**Step 4: Send Answers.** Please send both your tutorial exercise answers (the HTML file) and your book chapter exercise answers (as an R script) to Hasse and Caius on Slack by the end of the day Wednesday. 

**Step 5: Thursday group discussion.** We will meet as a group on Thursday to review the material covered, address any questions, and reflect on your progress. 
