...
If you haven't already, please visit [Posit](https://posit.co/download/rstudio-desktop/) for instructions on downloading and installing R and RStudio. The order is important: please begin by installing R and then proceed to the RStudio installation. Ensure that you choose the correct operating system.

![](images/clipboard-1657930642.png)
...
![](images/clipboard-1856791698.png)
...
![](images/clipboard-3704723856.png){width="434"}

If this is working, congratulations!

### Creating a new project in RStudio
#### 1.  Option 1: Create a New Project from Scratch
  -   Open RStudio
...
#### 2.  Option 2: Make an Existing Folder into a Project
